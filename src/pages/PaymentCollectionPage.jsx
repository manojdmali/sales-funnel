...
const PaymentCollectionPage = () => {
    ...
    const sheetKey = 'payment_collection';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 sm:mb-8">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">
                        Track invoice amounts, received payments, and TDS deductions
                    </p>
                </div>
                ...
                {/* Data Table */}
                <EnhancedTable
                    title={`Payment Collection Records (${data.length})`}
                    data={data}
                    columns={columns}
                    defaultSort={{ key: 'sales_person_name', direction: 'asc' }}
